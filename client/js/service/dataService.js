...
app.service('dataService', function dataService($rootScope, $http, performanceService) {
     ...
     * @fires module:dataService#initSuccess
     * @private
     */
    this.httpDownloadSuccess = function httpDownloadSuccess(response) {
        Object.assign(this, response.data);
        this.isReady = true;
        $rootScope.$broadcast('dataService#initSuccess');
     ...
     * @fires module:dataService#initError
     * @private
     */
    this.httpDownloadError = function httpDownloadError(response) {
        $rootScope.$broadcast('dataService#initError', response);
    };
     ...
     * @private
     */
    this.httpDownloadFinally = function httpDownloadFinally() {
     ...
     */
    this.getRandomSection = function getRandomSection(callback = () => true, upperLimit = 10000) {
        let section;
     ...
     * @see {@link https://docs.python.org/3/library/datetime.html#datetime.datetime.timestamp}
     */
    this.getTimestampNumber = function getTimestampNumber() {
 ...
 * @event module:dataService#initSuccess
 * @example $rootScope.$broadcast('dataService#initSuccess');
 * @example $scope.$on('dataService#initSuccess', (event) => { });
 */

/**
 * Date Service Initialization Error Event.
 * @event module:dataService#initError
 * @property {Promise} response Promise containing error information.
 * @example $rootScope.$broadcast('dataService#initError', response);
